...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Binary classification ROC paneli olusturur."
    )
    parser.add_argument(
        "--items",
        nargs="+",
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="outputs/Classification/classification_roc_panel.png",
    ...
    plt.plot(
        [0, 1], [0, 1], linestyle="--", color="gray", linewidth=1.0, label="Random"
    )
