...
def main() -> None:
	parser = argparse.ArgumentParser(description="Binary classification confusion matrix paneli olusturur.")
	parser.add_argument(
		"--items",
		nargs="+",
		required=True,
	...
	parser.add_argument(
		"--output",
		type=str,
		default="outputs/autoencoder/classification_confusion_matrix_panel.png",
